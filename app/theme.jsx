...
// getTheme(look, dark, accent) -> flat map of CSS custom properties applied on the app root.
...
const GM_LOOKS = {
  ...
  editorial: {
    ...
    displayWeight: 400,
    displayItalic: false,
    radius: 20, radiusLg: 30, radiusSm: 12,
    surfaceStyle: 'solid',
    light: {
      bg: '#F7F2EB', bgImage: 'none',
      surface: '#FFFFFF', surface2: '#FBF7F1',
      text: '#211A14', text2: 'rgba(33,26,20,0.62)', text3: 'rgba(33,26,20,0.40)',
      line: 'rgba(33,26,20,0.10)',
      glassBg: 'rgba(255,255,255,0.72)', glassBorder: 'rgba(255,255,255,0.8)',
    ...
    dark: {
      bg: '#161210', bgImage: 'none',
      surface: '#211C18', surface2: '#1A1613',
      text: '#F6EFE7', text2: 'rgba(246,239,231,0.60)', text3: 'rgba(246,239,231,0.38)',
      line: 'rgba(246,239,231,0.10)',
      glassBg: 'rgba(40,34,29,0.7)', glassBorder: 'rgba(255,255,255,0.08)',
  ...
  glass: {
    ...
    displayWeight: 700,
    displayItalic: false,
    radius: 26, radiusLg: 36, radiusSm: 16,
    surfaceStyle: 'glass',
    light: {
      bg: '#FBEFE9',
      bgImage: 'radial-gradient(120% 90% at 12% 2%, rgba(255,180,150,0.55), transparent 55%), radial-gradient(110% 80% at 95% 8%, rgba(255,150,190,0.45), transparent 50%), radial-gradient(120% 100% at 50% 110%, rgba(190,170,255,0.40), transparent 55%)',
      surface: 'rgba(255,255,255,0.55)', surface2: 'rgba(255,255,255,0.40)',
      text: '#2a1d22', text2: 'rgba(42,29,34,0.62)', text3: 'rgba(42,29,34,0.42)',
    ...
    dark: {
      bg: '#17121A',
      bgImage: 'radial-gradient(120% 90% at 12% 2%, rgba(200,90,70,0.40), transparent 55%), radial-gradient(110% 80% at 95% 8%, rgba(190,60,120,0.34), transparent 50%), radial-gradient(120% 100% at 50% 110%, rgba(110,80,200,0.34), transparent 55%)',
      surface: 'rgba(255,255,255,0.08)', surface2: 'rgba(255,255,255,0.05)',
      text: '#F6ECF1', text2: 'rgba(246,236,241,0.62)', text3: 'rgba(246,236,241,0.40)',
      line: 'rgba(255,255,255,0.12)',
      glassBg: 'rgba(40,30,40,0.45)', glassBorder: 'rgba(255,255,255,0.14)',
  ...
  mono: {
    ...
    displayWeight: 600,
    displayItalic: false,
    radius: 12, radiusLg: 18, radiusSm: 8,
    surfaceStyle: 'flat',
    light: {
      bg: '#EFEAE3', bgImage: 'none',
      surface: '#F7F4EF', surface2: '#EFEAE3',
      text: '#1A1714', text2: 'rgba(26,23,20,0.58)', text3: 'rgba(26,23,20,0.38)',
      line: 'rgba(26,23,20,0.14)',
      glassBg: 'rgba(247,244,239,0.78)', glassBorder: 'rgba(26,23,20,0.10)',
      navBg: 'rgba(239,234,227,0.85)',
      shadow: 'none',
      shadowLg: '0 12px 36px rgba(40,30,20,0.10)',
    },
    dark: {
      bg: '#121110', bgImage: 'none',
      surface: '#1B1917', surface2: '#161412',
      text: '#EFEAE3', text2: 'rgba(239,234,227,0.56)', text3: 'rgba(239,234,227,0.36)',
      line: 'rgba(239,234,227,0.14)',
      glassBg: 'rgba(27,25,23,0.82)', glassBorder: 'rgba(239,234,227,0.12)',
...
function gmTheme(look, dark, accentKey) {
...
Object.assign(window, { GM_ACCENTS, GM_LOOKS, gmTheme });
