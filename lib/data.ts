...
export const gradKeys = Object.keys(GRADS)

export type User = { id: string; name: string; handle: string; grad: string }
...
export const FEED: any[] = [
  ...
  },
  {
    ...
    id: "f2",
    groupId: "g_sam",
    title: "Sam is leaving for Lisbon 🛫",
    org: "jules",
    item: "buds",
    goal: 149,
    raised: 96,
    contributors: ["jules", "theo", "noor", "ivy"],
    count: 6,
    of: 9,
  },
  {
    ...
    likes: 88,
    savedBy: 12,
    comments: [{ user: "noor", text: "stealth gifting unlocked" }],
    you_liked: true,
    you_saved: false,
    fromSocial: "Spotify",
  },
  {
    ...
    user: "noor",
    time: "2h",
    text: "added 4 things to",
    target: "Apartment Warming",
    count: 4,
  ...
  },
  {
    type: "drop",
    id: "f5",
    title: "Today\u2019s Curated Drop",
    subtitle: "Cozy season picks, live for 24h",
    ends: "23:41:08",
    items: ["candle", "matcha", "slides", "beanie"],
  },
  {
    type: "find",
    id: "f6",
...
export const STYLE_TAGS = ["Film photography", "Cozy minimal", "Matcha core", "Vinyl", "Warm tones", "Cloud aesthetic", "Stationery"]
