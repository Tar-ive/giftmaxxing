    ...
    <div>
      ...
      <div style={{ padding: "20px 20px 40px" }}>
        ...
        <Section title="6. Your rights">
          ...
          />
          <P>
            To exercise any of these rights, contact us at <span style={{ color: "var(--accent)", fontWeight: 700 }}>privacy@giftmaxxing.com</span>. We will respond within 30 days.
          </P>
        </Section>
        ...
        <Section title="8. Children&apos;s privacy">
          <P>
            Giftmaxxing is not directed at children under 13. We do not knowingly collect personal data from children. If you believe a child has provided us with personal information, please contact us at <span style={{ color: "var(--accent)", fontWeight: 700 }}>privacy@giftmaxxing.com</span> and we will promptly delete it.
          </P>
        </Section>
        ...
        <Section title="11. Contact us">
          ...
          >
            <div style={{ fontWeight: 700, color: "var(--text)", marginBottom: 4 }}>Giftmaxxing Inc.</div>
            <div>Email: <span style={{ color: "var(--accent)" }}>privacy@giftmaxxing.com</span></div>
            <div>General: <span style={{ color: "var(--accent)" }}>hello@giftmaxxing.com</span></div>
          </div>
        </Section>
      </div>
    </div>
