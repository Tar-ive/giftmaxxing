...
import { Hanken_Grotesk, Instrument_Serif, Bricolage_Grotesque } from "next/font/google";
import "./globals.css";
...
export default function RootLayout({
  ...
  return (
    <html
      lang="en"
      className={`${hanken.variable} ${instrument.variable} ${bricolage.variable} h-full antialiased`}
    >
