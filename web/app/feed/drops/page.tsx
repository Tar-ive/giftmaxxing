...
// Drops surface = curated gift packages ("bundles") worth a target amount,
// assembled from the real-photo pin set. Add the whole bundle to your cart, or
// turn it into a group-gift pool.
export default function DropsPage() {
  return (
    <div className="mx-auto max-w-5xl px-4 py-8">
      <header className="mb-6">
        <h1 className="font-display text-3xl font-extrabold text-ink">Drops</h1>
        <p className="mt-1 text-ink-soft">Curated gift packages — refreshed picks, bundled and ready to gift.</p>
      </header>
...
function DropCard({ drop }: { drop: DropPackage }) {
